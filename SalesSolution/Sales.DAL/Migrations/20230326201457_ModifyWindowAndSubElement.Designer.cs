...
namespace Sales.DAL.Migrations
{
    ...
    [Migration("20230326201457_ModifyWindowAndSubElement")]
    partial class ModifyWindowAndSubElement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sales.DAL.Entities.ElementType", b =>
                {
                    b.Property<Guid>("UId")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Sales.DAL.Entities.Order", b =>
                {
                    b.Property<Guid>("UId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Sales.DAL.Entities.SubElement", b =>
                {
                    b.Property<Guid>("UId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SubElements", t =>
                        {
                            t.HasTrigger("tr_element_types_update");

                            t.HasTrigger("tr_sub_elements_update");
                        });
            ...
            modelBuilder.Entity("Sales.DAL.Entities.Window", b =>
                {
                    b.Property<Guid>("UId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Windows", t =>
                        {
                            t.HasTrigger("tr_windows_update");
                        });
            ...
            modelBuilder.Entity("Sales.DAL.Entities.SubElement", b =>
                {
                    b.HasOne("Sales.DAL.Entities.ElementType", "ElementType")
                        .WithMany()
                        .HasForeignKey("ElementTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sales.DAL.Entities.Window", "Window")
            ...
            modelBuilder.Entity("Sales.DAL.Entities.Window", b =>
                {
                    b.HasOne("Sales.DAL.Entities.Order", "Order")
                        .WithMany("Windows")
